...
converted_object <- convertTo(sce, type=opt$type, assay=opt$assay, fData.col=opt$fData_col, dData.col=opt$dData_col, equiweight=opt$equiweight, normalize=opt$normalize, get.spikes=opt$get_spikes)
